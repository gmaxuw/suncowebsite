  ...
  useEffect(() => {
    const load = async () => {
      ...
      setEditForm({
        ...
        alternate_contact_name:     memberData?.alternate_contact_name     || "",
        alternate_contact_number:   memberData?.alternate_contact_number   || "",
        alternate_contact_relation: memberData?.alternate_contact_relation || "",
      });
    ...
    <main style={{ minHeight: "100vh", background: "#F0EDE6", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {editOpen && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", zIndex: 300, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
          <div style={{ background: "white", borderRadius: 14, width: "100%", maxWidth: 520, maxHeight: "92vh", overflowY: "auto", boxShadow: "0 24px 60px rgba(0,0,0,0.3)" }}>

            {/* Header */}
            <div style={{ padding: "1.3rem 1.6rem", background: "#0D3320", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 10 }}>
              <div>
            ...
            <div style={{ padding: "1.5rem 1.6rem" }}>
              ...
              {/* Photo */}
              <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: "1.5rem", padding: "1rem", background: "#F9F8F5", borderRadius: 10 }}>
              ...
              <div style={{ marginBottom: "1.4rem" }}>
                <p style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#0D3320", marginBottom: "0.8rem", paddingBottom: "0.4rem", borderBottom: "1.5px solid rgba(26,92,42,0.1)" }}>
                  Contact Information
                </p>
                <div style={{ marginBottom: "0.9rem" }}>
                  <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Mobile Number</label>
                  <input value={editForm.mobile} onChange={e => setEditForm(prev => ({ ...prev, mobile: e.target.value }))} placeholder="e.g. 0917-000-0000" type="tel"
                    style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Home Address</label>
                  <input value={editForm.address} onChange={e => setEditForm(prev => ({ ...prev, address: e.target.value }))} placeholder="Barangay, Municipality, Province"
                    style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                </div>
              </div>
              ...
              <div style={{ marginBottom: "1.4rem" }}>
                ...
                <div>
                  <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Tax Identification Number (TIN)</label>
                  <input value={editForm.tin} onChange={e => setEditForm(prev => ({ ...prev, tin: e.target.value }))} placeholder="e.g. 123-456-789-000"
                    style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "monospace", outline: "none", color: "#0D3320", boxSizing: "border-box" as const, letterSpacing: "0.04em" }} />
                  <p style={{ fontSize: "0.68rem", color: "#BBB", marginTop: 4 }}>Required for SEC General Information Sheet (GIS). Leave blank if not yet issued.</p>
                </div>
              </div>
              ...
              <div style={{ marginBottom: "1.4rem" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.8rem" }}>
                  <div>
                    <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Beneficiary Name</label>
                    <input value={editForm.beneficiary_name} onChange={e => setEditForm(prev => ({ ...prev, beneficiary_name: e.target.value }))} placeholder="Full name"
                      style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Relationship</label>
                    <input value={editForm.beneficiary_relation} onChange={e => setEditForm(prev => ({ ...prev, beneficiary_relation: e.target.value }))} placeholder="e.g. Spouse, Child"
                      style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginBottom: "1.4rem" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.8rem", marginBottom: "0.8rem" }}>
                  <div>
                    <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Full Name</label>
                    <input value={editForm.alternate_contact_name} onChange={e => setEditForm(prev => ({ ...prev, alternate_contact_name: e.target.value }))} placeholder="e.g. Maria dela Cruz"
                      style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Relationship</label>
                    <input value={editForm.alternate_contact_relation} onChange={e => setEditForm(prev => ({ ...prev, alternate_contact_relation: e.target.value }))} placeholder="e.g. Spouse, Child"
                      style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                  </div>
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#999", marginBottom: 5, fontWeight: 600 }}>Contact Number</label>
                  <input value={editForm.alternate_contact_number} onChange={e => setEditForm(prev => ({ ...prev, alternate_contact_number: e.target.value }))} placeholder="09XX XXX XXXX" type="tel"
                    style={{ width: "100%", padding: "0.72rem 1rem", border: "1.5px solid rgba(0,0,0,0.12)", borderRadius: 8, fontSize: "0.95rem", fontFamily: "'DM Sans', sans-serif", outline: "none", color: "#0D3320", boxSizing: "border-box" as const }} />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.7rem" }}>
                ...
                <button onClick={handleSaveProfile} disabled={saving} style={{ padding: "0.8rem", background: saving ? "rgba(13,51,32,0.5)" : "#0D3320", border: "none", borderRadius: 8, fontSize: "0.88rem", color: "white", cursor: saving ? "not-allowed" : "pointer", fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}>
